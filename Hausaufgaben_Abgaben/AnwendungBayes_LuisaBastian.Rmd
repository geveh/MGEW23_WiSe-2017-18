    ...
    tabsetPanel(type = "tab",
        tabPanel("Textausgabe", # Panel fuer Anzeige der Wahrscheinlichkeit als Text
             tags$div(
                ...
                paste("Die Posterior-Wahrscheinlichkeit beträgt",sum((input$likelihood*input$prior),((1-input$likelihood)*(1-input$prior))),".")#output
                })
              )
        ),
...
plot(sum((input$likelihood*input$prior),((1-input$likelihood)*(1-input$prior))), main="Posterior", type="h", xlim=c(0,1), ylim=c(0,1)) #Posterior
             })
             )
        ),
...
##### Interaktives und Grafiken
  ...
  - Die 2D-Plots zeigen vermutlich die falschen Variablen an.
  - Die Abhängigkeit der Likelihood von wahren und falschen Fällen muss implementiert werden. (Dafür einen ganz neuen Plot erstellen, damit die Inputs "Likelihood" und "Wahre/Falsche Fälle" nicht widersprechen?)
